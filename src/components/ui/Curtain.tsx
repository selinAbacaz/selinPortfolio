...
return(
    ...
    <div className="backgroundBody" >
            <div style={{display:"flex", flexDirection:"row"}}>
                <div style= {{height: "75vw", width: pillarWidth, backgroundColor: "var(--myLightGreen)", borderBottomLeftRadius: "60px", borderBottomRightRadius: "60px"}}></div>
                <div style= {{height: "65vw", width: pillarWidth, backgroundColor: "var(--myLightGreen)", borderBottomLeftRadius: "60px", borderBottomRightRadius: "60px"}}></div>
                ...
                <div style= {{height: "55vw", width: pillarWidth, backgroundColor: "var(--myLightGreen)", borderBottomLeftRadius: "60px", borderBottomRightRadius: "60px"}}></div>
